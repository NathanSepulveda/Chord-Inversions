    ...
    <div>
      ...
      <div style={{display: "flex", flexDirection: "row", justifyContent: "space-between"}}>
        ...
        <p style={{ fontSize: "10px", lineHeight: "25px" }}>
            (You're on mobile, make sure your sound is on!){" "}
          </p>  
      </div>
      {isShowing ? (
        <div style={{ marginBottom: "5px" }}>
          <ol style={{ marginTop: "-10px" }}>
            ...
            <li>
              After this chord is added, you can add the rest of the chords in
              the progression one by one. You will only be selecting the root,
              if it's sharp or flat, and the quality of the chord for every
              chord except the first.
            </li>
            <li>
              With your selected chord progression, press the "play" button at
              the bottom to hear and see your chord progression with the best
              chord inversions!
            </li>
            <li>
            ...
            <li>
              You can delete all but the first chord by clicking the red x in
              the top right corner of a chord node.
            </li>
            <li>
